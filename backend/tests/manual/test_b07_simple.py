...
def test_torch_import():
 ...
 print(f"\n TEST 2 OMITIDO: PyTorch no instalado")
...
def test_resnet_loading():
 ...
 print(f"\n TEST 6 OMITIDO: PyTorch/TorchVision no instalado")
 return True
...
def main():
 ...
 print("\n Los componentes esenciales están funcionando")
 print(" Algunos componentes opcionales no están disponibles")
 return 0
 else:
 print(f"\n {total - passed} TEST(S) FALLIDO(S)")
 print("\n Faltan dependencias críticas. Instalar con:")
