...
export function NewReportForm() {
  ...
  // El formulario se monta tanto en /portal (ciudadano) como en /dashboard
  // (staff): la navegación de salida debe volver al home del rol activo.
  const isCitizen = user?.role === UserRole.CIUDADANO;
  const homeHref = isCitizen ? '/portal' : '/dashboard';
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      >
        ...
        {isCitizen ? t('nav.backToPortal') : t('nav.backToDashboard')}
      </Link>
